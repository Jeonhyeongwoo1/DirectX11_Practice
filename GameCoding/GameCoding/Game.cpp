...
void Game::CreateGeometry()
{
	...
	//VertexBuffer
	{
		...
		desc.BindFlags = D3D11_BIND_VERTEX_BUFFER; //정점 버퍼를 사용
...
void Game::CreateInputLayout()
{
	D3D11_INPUT_ELEMENT_DESC layout[] =
	{
		...
		//Color에 대한 묘사(12인 이유 앞에서 이미 4바이트 짜리 float변수가 3개 있으므로 12바이트 뒤에 선언)
...
void Game::CreateDeviceAndSwapChain()
{
	...
	ZeroMemory(&desc, sizeof(desc)); //Memset 즉 초기화
	{
